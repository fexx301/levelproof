...
failures (a keyless shortcut, a player who seals themselves in) before you
ship them.

- **Build:** express a layout change and puzzle intent in natural language.
- **Break:** inspect the attempted edit and replay the checker's counterexample.
- **Repair:** compare checked fixes that preserve your design requirements.
